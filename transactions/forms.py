...
class FundTransferByCardForm(forms.Form):
    card_one = forms.ModelChoiceField(queryset=None, empty_label="Select Card", label="Select Card",
                                      widget=forms.Select)
    card_two = forms.ModelChoiceField(queryset=None, empty_label="Select Card", label="Select Card",
                                      widget=forms.Select)
    amount = forms.DecimalField(label='Amount', max_digits=12, decimal_places=2)
